<?php
// Finnish home page translations for Involved! application
// Last updated: 2025-05-03

return [
    'involved_intro_title' => 'Osallistu!',
    ...
    'password_placeholder' => 'Salasana (valinnainen)',
    'create_event_button' => 'Luo Uusi Tapahtuma',
    
    // Password prompt page
    'protected_event_title' => 'Suojattu Tapahtuma',
    'password_prompt_description' => 'Tämä tapahtuma vaatii salasanan. Syötä se alle jatkaaksesi.',
    'password_label' => 'Salasana',
    'password_prompt_placeholder' => 'Syötä tapahtuman salasana',
    ...
    'created_at' => 'Luotu:',
    'word_clouds_title' => 'Sanapilvet',
    'no_word_clouds' => 'Ei vielä sanapilviä.',
    'enter_question_placeholder' => 'Syötä kysymys',
    'create_word_cloud_button' => 'Luo Sanapilvi',
    'confirm_delete_wordcloud' => 'Oletko varma, että haluat poistaa tämän sanapilven?',
    'delete_failed' => 'Sanapilven poistaminen epäonnistui',
    ...
    'invalid_password' => 'Virheellinen salasana. Yritä uudelleen.',
    'word_cloud_create_failed' => 'Sanapilven luominen epäonnistui',
    'wordcloud_not_found' => 'Sanapilveä ei löydy',
    'missing_word' => 'Sana vaaditaan',
    'word_add_failed' => 'Sanan lisääminen epäonnistui',
    'unauthorized_access' => 'Luvaton pääsy-yritys',
    'word_parameter_is_required' => 'Sanaparametri vaaditaan',
