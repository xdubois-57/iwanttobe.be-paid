<?php
// Croatian home page translations for Involved! application
// Last updated: 2025-05-03

return [
    'involved_intro_title' => 'Uključite se!',
    ...
    'protected_event_title' => 'Zaštićeni Događaj',
    'password_prompt_description' => 'Ovaj događaj zahtijeva lozinku. Unesite je ispod da biste nastavili.',
    'password_label' => 'Lozinka',
    'password_prompt_placeholder' => 'Unesite lozinku događaja',
    'continue_button' => 'Nastavite',
    'error_heading' => 'Greška:',
    ...
    'created_at' => 'Stvoreno:',
    'word_clouds_title' => 'Oblaci Riječi',
    'no_word_clouds' => 'Još nema oblaka riječi.',
    'enter_question_placeholder' => 'Unesite pitanje',
    'create_word_cloud_button' => 'Stvorite Oblak Riječi',
    'confirm_delete_wordcloud' => 'Jeste li sigurni da želite izbrisati ovaj oblak riječi?',
    'delete_failed' => 'Brisanje oblaka riječi nije uspjelo',
    ...
    // Controller messages
    'event_create_failed' => 'Stvaranje događaja nije uspjelo. Greška:',
    'event_not_found' => 'Događaj nije pronađen',
    'invalid_password' => 'Nevažeća lozinka. Molimo pokušajte ponovno.',
    'word_cloud_create_failed' => 'Stvaranje oblaka riječi nije uspjelo',
    'wordcloud_not_found' => 'Oblak riječi nije pronađen',
    'missing_word' => 'Riječ je obavezna',
    'word_add_failed' => 'Dodavanje riječi nije uspjelo',
    'unauthorized_access' => 'Neovlašteni pokušaj pristupa',
    'word_parameter_is_required' => 'Parametar riječi je obavezan',
