<?php
// Icelandic home page translations for Involved! application
// Last updated: 2025-05-03

return [
    'involved_intro_title' => 'Taktu þátt!',
    ...
    'password_placeholder' => 'Lykilorð (valfrjálst)',
    'create_event_button' => 'Búa til Nýjan Viðburð',
    
    // Password prompt page
    'protected_event_title' => 'Verndaður Viðburður',
    'password_prompt_description' => 'Þessi viðburður krefst lykilorðs. Vinsamlegast sláðu það inn hér að neðan til að halda áfram.',
    'password_label' => 'Lykilorð',
    'password_prompt_placeholder' => 'Sláðu inn lykilorð viðburðar',
    'continue_button' => 'Halda áfram',
    'error_heading' => 'Villa:',
    ...
    'created_at' => 'Búið til:',
    'word_clouds_title' => 'Orðský',
    'no_word_clouds' => 'Engin orðský ennþá.',
    'enter_question_placeholder' => 'Sláðu inn spurningu',
    'create_word_cloud_button' => 'Búa til Orðský',
    'confirm_delete_wordcloud' => 'Ertu viss um að þú viljir eyða þessu orðskýi?',
    'delete_failed' => 'Eyðing orðskýs mistókst',
    ...
    'invalid_password' => 'Ógilt lykilorð. Vinsamlegast reyndu aftur.',
    'word_cloud_create_failed' => 'Ekki tókst að búa til orðský',
    'wordcloud_not_found' => 'Orðský fannst ekki',
    'missing_word' => 'Orð er nauðsynlegt',
