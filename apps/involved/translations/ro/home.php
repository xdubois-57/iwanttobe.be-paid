<?php
// Romanian home page translations for Involved! application
// Last updated: 2025-05-03

return [
    'involved_intro_title' => 'Implică-te!',
    ...
    'password_placeholder' => 'Parolă (opțional)',
    'create_event_button' => 'Creează Eveniment Nou',
    
    // Password prompt page
    'protected_event_title' => 'Eveniment Protejat',
    'password_prompt_description' => 'Acest eveniment necesită o parolă. Te rugăm să o introduci mai jos pentru a continua.',
    'password_label' => 'Parolă',
    'password_prompt_placeholder' => 'Introdu parola evenimentului',
    'continue_button' => 'Continuă',
    'error_heading' => 'Eroare:',
    ...
    'created_at' => 'Creat la:',
    'word_clouds_title' => 'Nori de Cuvinte',
    'no_word_clouds' => 'Încă nu există nori de cuvinte.',
    'enter_question_placeholder' => 'Introdu o întrebare',
    'create_word_cloud_button' => 'Creează Nor de Cuvinte',
    'confirm_delete_wordcloud' => 'Ești sigur că vrei să ștergi acest nor de cuvinte?',
    'delete_failed' => 'Ștergerea norului de cuvinte a eșuat',
    ...
    'invalid_password' => 'Parolă invalidă. Te rugăm să încerci din nou.',
    'word_cloud_create_failed' => 'Crearea norului de cuvinte a eșuat',
    'wordcloud_not_found' => 'Nor de cuvinte negăsit',
    'missing_word' => 'Cuvântul este obligatoriu',
    'word_add_failed' => 'Adăugarea cuvântului a eșuat',
    'unauthorized_access' => 'Încercare de acces neautorizată',
    'word_parameter_is_required' => 'Parametrul cuvânt este obligatoriu',
