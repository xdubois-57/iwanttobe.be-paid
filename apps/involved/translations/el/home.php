...
return [
    ...
    'join_event_description' => 'Εισάγετε έναν 4-ψήφιο κωδικό για να συμμετάσχετε σε μια υπάρχουσα εκδήλωση.',
    'event_code_placeholder' => 'Κωδικός εκδήλωσης',
    ...
    'word_added_success' => 'Η λέξη σας προστέθηκε με επιτυχία!',
    'please_enter_word' => 'Παρακαλώ εισάγετε μια λέξη.',
    'word_input_placeholder' => 'Εισάγετε την απάντησή σας (μέγιστο 30 χαρακτήρες)',
