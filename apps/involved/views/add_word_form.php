...
<main class="container">
    <article>
        ...
        <div style="text-align: center; margin-top: 1.5rem;">
            <div id="emoji-buttons" style="display:inline-flex;">
                <button class="emoji-btn" data-emoji="❤️" type="button" style="background:none; border:none; cursor:pointer; font-size:1.5rem; transition:transform 0.2s;">❤️</button>
                <button class="emoji-btn" data-emoji="😂" type="button" style="background:none; border:none; cursor:pointer; font-size:1.5rem; transition:transform 0.2s;">😂</button>
                <button class="emoji-btn" data-emoji="👍" type="button" style="background:none; border:none; cursor:pointer; font-size:1.5rem; transition:transform 0.2s;">👍</button>
                <button class="emoji-btn" data-emoji="🔥" type="button" style="background:none; border:none; cursor:pointer; font-size:1.5rem; transition:transform 0.2s;">🔥</button>
                <button class="emoji-btn" data-emoji="🎉" type="button" style="background:none; border:none; cursor:pointer; font-size:1.5rem; transition:transform 0.2s;">🎉</button>
                <button class="emoji-btn" data-emoji="😅" type="button" style="background:none; border:none; cursor:pointer; font-size:1.5rem; transition:transform 0.2s;">😅</button>
