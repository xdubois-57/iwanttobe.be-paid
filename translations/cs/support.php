<?php
// Czech support translations for <strong>Paid!</strong> application
// Contains all text for the support page
// Last updated: 2025-04-13

return [
    'support_title' => 'Podpořte <strong>Paid!</strong>',
    'support_hosting_title' => 'Náklady na hosting',
    'support_hosting_text' => '<strong>Paid!</strong> je hostován na bezpečných serverech, aby vaše údaje zůstaly soukromé a služba byla rychlá. Vaše podpora nám pomáhá pokrýt náklady na hosting.',
    'support_development_title' => 'Kontinuální vývoj',
    'support_development_text' => 'Neustále vylepšujeme <strong>Paid!</strong> novými funkcemi a lepším uživatelským zážitkem. Vaše příspěvky nám pomáhají věnovat více času vývoji.',
    ...
    'support_thanks' => 'Děkuji za podporu <strong>Paid!</strong>!',
